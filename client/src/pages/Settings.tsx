  ...
  return (
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="card p-4 sm:p-6">
        ...
        <p className="text-sm text-gray-600 dark:text-slate-300 mb-4">
          Baixe o guia completo do CRM com passo a passo de todas as funcionalidades, dicas de uso, integracoes e busca embutida. O arquivo abre offline em qualquer navegador e pode ser impresso em PDF.
        </p>
